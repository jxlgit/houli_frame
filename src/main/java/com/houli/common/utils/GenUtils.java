...
import com.houli.common.domain.ColumnDO;
import com.houli.common.domain.GeneratorDO;
import com.houli.common.domain.TableDO;

/**
 * 
 * @Description:    代码生成器   工具类   
 * @author: jxl     
 * @date:   2018年11月9日 下午4:18:20   
 * @version V1.0
 */
public class GenUtils {


    public static List<String> getTemplates(int templateIndex) {
    	
        List<String> templates = new ArrayList<String>();
        templates.add("templates/common/generator/vm/domain.java.vm");
        templates.add("templates/common/generator/vm/Dao.java.vm");
        templates.add("templates/common/generator/vm/Mapper.xml.vm");
        templates.add("templates/common/generator/vm/Service.java.vm");
        templates.add("templates/common/generator/vm/ServiceImpl.java.vm");
        
        switch (templateIndex) {
		case 1:
			templates.add("templates/common/generator/vm/template1/Controller.java.vm");
			templates.add("templates/common/generator/vm/template1/list.html.vm");
			templates.add("templates/common/generator/vm/template1/list.js.vm");
			break;
		case 2:
			templates.add("templates/common/generator/vm/template2/Controller.java.vm");
			templates.add("templates/common/generator/vm/template2/add.html.vm");
			templates.add("templates/common/generator/vm/template2/edit.html.vm");
			templates.add("templates/common/generator/vm/template2/list.html.vm");
			templates.add("templates/common/generator/vm/template2/preview.html.vm");
			templates.add("templates/common/generator/vm/template2/list.js.vm");
			break;
        }
    ...
    public static void generatorCode(GeneratorDO table, List<Map<String, String>> columns, ZipOutputStream zip) {
        //配置信息
...
//        tableDO.setComments(table.get("tableComment"));
        ...
        //获取模板列表
        List<String> templates = getTemplates(config.getInt("templateIndex"));
...
//		}
        ...
        if (template.contains("preview.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                    + packageName + File.separator + classname + File.separator + "preview.html";
        }

        if (template.contains("list.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "app" + File.separator + "js" + File.separator
